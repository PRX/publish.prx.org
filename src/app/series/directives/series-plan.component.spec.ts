...
describe('SeriesPlanComponent', () => {
  ...
  cit('loads the series templates', (_fix, _el, comp) => {
    ...
    expect(comp.templateOptions).toEqual([
      ['one', '/link/one'],
      ['two', '/link/two']
    ]);
  ...
  cit('plans episodes with a max number', (_fix, _el, comp) => {
    ...
    expect(comp.planned.map((d) => `${d}`)).toEqual(['2019-02-12', '2019-02-26', '2019-03-12', '2019-03-26', '2019-04-09', '2019-04-23']);
  });
  ...
  cit('plans episodes every other week', (_fix, _el, comp) => {
    ...
    expect(comp.planned.map((d) => `${d}`)).toEqual(['2019-02-04', '2019-02-18', '2019-03-04', '2019-03-18', '2019-04-01']);
  });
